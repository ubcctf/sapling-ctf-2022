...
#
# probably a good idea to run with `-debug` and connect w/ gdb over port 1234
#
$QEMUBIN -monitor none -serial stdio -M versatilepb -nographic -m 8 -kernel $IMAGE_FILE $QEMU_GDB_ARG
